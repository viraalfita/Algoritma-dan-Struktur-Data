...
public class LigaPutri {
    ...
    public void tambahTim(String nama) {
        NodePutri timBaru = new NodePutri(nama);
    ...
    public void catatPertandingan(String tim1, String tim2, String pemenang, String skor) {
        NodePutri t1 = cariTim(tim1);
        NodePutri t2 = cariTim(tim2);
    ...
    public NodePutri cariTim(String nama) {
        NodePutri temp = head;
        while (temp != null) {
    ...
    private void urutkanTimBerdasarkanPoin() {
        ...
        boolean swapped;
        do {
            NodePutri current = head;
            NodePutri previous = null;
            NodePutri next = head.next;
            swapped = false;
